...
export default function HeinXDashboard() {
  ...
  const [messages, setMessages] = useState([
    ...
    { sender: "You", text: "Yes, let's achieve my goals.", timestamp: "9:24 AM" }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">HeinX AI</h1>
                <p className="text-xs sm:text-sm text-gray-500">Intelligent Assistant Platform</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {user.isPremium && (
                <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-indigo-100 rounded-full">
